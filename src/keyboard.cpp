...
int CKeyboard :: getkey()
{
  printf("%s\n", getkeyvalue());
  return getkeyvalue();
}

int CKeyboard :: ungetkey(int character)
{
  return ungetch(character);
}

int CKeyboard :: wait_for_key()
{
  int character;
...
string CKeyboard :: get_name(int posx, int posy, int size)
{
  char character;
  char temp[2];
  string imie;
...
int CKeyboard :: get_value(int posx, int posy, int size)
{
	char character;
	char temp[2];
	string value;
...
int CKeyboard :: get_direction(int &dx, int &dy)
{
      int key;
      dx=0;
      dy=0;
