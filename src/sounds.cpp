...
bool CSounds::PlayMusic(const string &songname)
{
	if (!initialized)
		return false;
...
bool CSounds::PlaySoundOnce(const string &soundname, int volume)
{
	if (!initialized)
		return false;
...
FMUSIC_MODULE *CSounds::LoadMusic(const string &songname)
{
	if (!initialized)
		return false;
...
FSOUND_SAMPLE *CSounds::LoadSound(const string &songname)
{
	if (!initialized)
		return false;
